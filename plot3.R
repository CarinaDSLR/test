...
# Now lets plot the date on the x-axis and Sub_metering 1-3 on the y axis
png(filename="plot3.png",  width=480, height=480) # width&height not necessary, as 480x480 = default
